...
const initialCropper = function(){
  var canvasScale = Number(800/250)
  var ImageFile = {};
    (function (factory) {
     ...
     $.extend(prototype, {
       ...
       initCanvas: function () {
        ...
        // canvas.oldLeft = canvas.left =containerWidth > canvas.width ? (containerWidth - canvas.width) / 2 : 0;
        // canvas.oldTop = canvas.top = containerHeight > canvas.height ? (containerHeight - canvas.height) / 2 : 0;
        /*原代码*/
       ...
       renderCanvas: function (changed) {
         ...
         /*修改代码*/
        // canvas.width = this.image.naturalWidth/canvasScale;
        // canvas.height = this.image.naturalHeight/canvasScale;
         /*原代码*/
         ...
         this.$canvas.css({
           /*修改代码*/
          //  width: this.image.naturalWidth/canvasScale,
          //  height: this.image.naturalHeight/canvasScale,
           /*原代码*/
           width: canvas.width ,
       ...
       initCropBox: function () {
        ...
        //  cropBox.height = max(cropBox.minHeight, cropBox.height * autoCropArea);
         ...
         cropBox.height = 250;
        /*修改代码*/
        // cropBox.oldLeft = cropBox.left = canvas.left + (this.container.width - cropBox.width) / 2;
        // cropBox.oldTop = cropBox.top = canvas.top + (this.container.height - cropBox.height) / 2;
        /*原代码*/
     ...
     prototype.preview = function () {
       var image = this.image,
           canvas = this.canvas,
           cropBox = this.cropBox,
           width = this.width,//image.naturalWidth/canvasScale,//////////////////////////////
           height = this.height,//image.naturalHeight/canvasScale,//////////////////////////////
  ...
  $(function () {
    ...
    (function () {
      ...
      ImageFile.getCroppedCanvas = (option) => {
