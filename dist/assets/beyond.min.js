...
function InitiateSideMenu() {
    ...
    $(".sidebar-menu").on("click", function (t) {
        ...
        if (i && i.length != 0) {//!$("#sidebar").hasClass("menu-compact") && !$("#sidebar").hasClass("menu-compact")
            ...
            return n && $(r.parentNode.parentNode).hasClass("sidebar-menu") ? !1 : ($(r).slideToggle(200).parent().toggleClass("open"), true)//true传递事件，false屏蔽事件
        }
    })
}
